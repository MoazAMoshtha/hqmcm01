                                            ...
                                            <div class="form-group row justify-content-lg-center">
                                                ...
                                                <div class=" col-md-7">
                                                    <input id="firstName" type="text"
                                                           ...
                                                           name="firstName" value="<?php if (isset($teacher[0]['firstName'])) {
                                            ...
                                            <div class="form-group row justify-content-lg-center">
                                                ...
                                                <div class=" col-md-7">
                                                    <input id="secondName" type="text"
                                                           ...
                                                           name="secondName" value="<?php if (isset($teacher[0]['secondName'])) {
                                            ...
                                            <div class="form-group row justify-content-lg-center">
                                                ...
                                                <div class=" col-md-7">
                                                    <input id="familyName" type="text"
                                                           ...
                                                           name="familyName" value="<?php if (isset($teacher[0]['familyName'])) {
                                            ...
                                            <div class="form-group row justify-content-lg-center">
                                                ...
                                                <div class=" col-md-7">
                                                    <input id="id_number" type="text"
                                                           ...
                                                           name="id_number" value="<?php if (isset($teacher[0]['id_number'])) {
                                            ...
                                            <div class="form-group row justify-content-lg-center">
                                                ...
                                                <div class="col-md-7">
                                                    <input placeholder="059/056" id="phoneNumber" type="text"
                                                           ...
                                                           name="phoneNumber" value="<?php if (isset($teacher[0]['phoneNumber'])) {
