@include('includes.navbar')
    <div class="float-right navbar-dark bg-dark ml-3 " style="width: 15%">
        <ul class="navbar-nav text-right mr-3">
            <li class="navbar-brand"><a class="nav-link" href="">{{Auth::user()->firstName . " " . Auth::user()->familyName}}</a></li>
