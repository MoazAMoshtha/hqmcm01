    ...
    <div class="container ">
        <table class="table">
            ...
            @foreach ($students as $student)
                <tr>
                    <td><a href='{{route('daily_record' , $student->hqmcm_id )}}'>تسجيل</a></td>
                    <td>{{\App\Daily::where('student_hqmcm_id' , $student->hqmcm_id)->get()->last()}}</td>
                    <td>{{\App\Daily::where('student_hqmcm_id' , $student->hqmcm_id)->get()->last()}}</td>
                ...
                <div class="card-body">
                    <div class="row justify-content-center">
                        ...
                        <div class=" col-lg-4 order-lg-1 row form-group">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control order-lg-0" type="text">
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <button type="submit" class="btn btn-primary mb-2">تسجيل</button>                    </div>
                </div>
            @endif
        </div>
    </div>
